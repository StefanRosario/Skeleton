...
<body style="height: 283px">
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="btnFind" runat="server" OnClick="btnFind_Click" style="z-index: 1; left: 319px; top: 18px; position: absolute" Text="Find" />
        </div>
...
&nbsp;<asp:TextBox ID="txtDescription" runat="server" style="z-index: 1; left: 93px; top: 91px; position: absolute"></asp:TextBox>
        ...
        <p>
            ...
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="z-index: 1; left: 17px; top: 354px; position: absolute" Text="View Stock" />
        </p>
        <p>
        ...
        <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" style="z-index: 1; left: 16px; top: 315px; position: absolute" Text="OK" />
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 56px; top: 315px; position: absolute" Text="Cancel" />
        <p>
            &nbsp;</p>
    </form>
</body>
