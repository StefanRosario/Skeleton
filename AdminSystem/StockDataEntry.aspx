...
&nbsp;<asp:TextBox ID="txtDescription" runat="server" style="z-index: 1; left: 93px; top: 91px; position: absolute"></asp:TextBox>
        ...
        <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" style="z-index: 1; left: 17px; top: 308px; position: absolute" Text="OK" />
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 57px; top: 308px; position: absolute" Text="Cancel" />
    </form>
</body>
</html>
