...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnClear" runat="server" OnClick="BtnClear_Click" style="z-index: 1; left: 80px; top: 510px; position: absolute" Text="Clear" />
        ...
        <asp:Button ID="btnApply" runat="server" OnClick="BtnApply_Click" style="z-index: 1; left: 16px; top: 511px; position: absolute; right: 612px" Text="Apply" />
    </form>
</body>
</html>
