...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:TextBox ID="TextBox1" runat="server" style="z-index: 1; left: 150px; top: 47px; position: absolute; width: 140px;" height="22px"></asp:TextBox>
        </p>
        <p>
        ...
        <asp:TextBox ID="TextBox2" runat="server" style="z-index: 1; left: 150px; top: 77px; position: absolute; width: 140px;" height="22px"></asp:TextBox>
        ...
        <asp:TextBox ID="TextBox3" runat="server" style="z-index: 1; left: 151px; top: 106px; position: absolute; width: 140px;" height="22px"></asp:TextBox>
        ...
        <asp:TextBox ID="TextBox4" runat="server" style="z-index: 1; left: 151px; top: 141px; position: absolute; width: 140px;" height="22px"></asp:TextBox>
        <asp:Label ID="lblPhoneNo" runat="server" style="z-index: 1; left: 35px; top: 176px; position: absolute" Text="Phone Number"></asp:Label>
        <asp:TextBox ID="TextBox5" runat="server" style="z-index: 1; left: 151px; top: 177px; position: absolute; width: 140px;"></asp:TextBox>
        ...
        <asp:TextBox ID="TextBox6" runat="server" style="z-index: 1; left: 150px; top: 207px; position: absolute; height: 22px; width: 140px;"></asp:TextBox>
